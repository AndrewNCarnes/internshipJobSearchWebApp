...
API_BASE = "https://boeing.wd1.myworkdayjobs.com/wday/cxs/boeing/EXTERNAL_CAREERS"
API_URL = f"{API_BASE}/jobs"
BASE_JOB_URL = "https://boeing.wd1.myworkdayjobs.com/en-US/EXTERNAL_CAREERS"
...
# can't be trusted. Blue Origin's facet reports 1 intern while text search finds
# 17 -- the rest are filed as "Regular", so using it would delete 16 real jobs.
# RTX tags 49 properly and is safe. Boeing is decided at runtime by this check.
