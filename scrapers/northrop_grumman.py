...
API_BASE = "https://ngc.wd1.myworkdayjobs.com/wday/cxs/ngc/Northrop_Grumman_External_Site"
API_URL = f"{API_BASE}/jobs"
BASE_JOB_URL = "https://ngc.wd1.myworkdayjobs.com/en-US/Northrop_Grumman_External_Site"
...
# can't be trusted. Observed so far: RTX 49 (trusted), Boeing 16 (trusted),
# Blue Origin 1 (rejected -- text search finds 17, so the facet would have
# deleted 16 real jobs). Falling back costs time; a bad facet costs postings.
MIN_FACET_TRUST = 5
