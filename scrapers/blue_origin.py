...
API_BASE = "https://blueorigin.wd5.myworkdayjobs.com/wday/cxs/blueorigin/BlueOrigin"
API_URL = f"{API_BASE}/jobs"
BASE_JOB_URL = "https://blueorigin.wd5.myworkdayjobs.com/en-US/BlueOrigin"

# Workday/Cloudflare returns 403 without Origin and Referer.
HEADERS = {
    "Accept": "application/json",
    "Content-Type": "application/json",
    "Origin": "https://blueorigin.wd5.myworkdayjobs.com",
    "Referer": BASE_JOB_URL,
}

INTERN_FACET_PARAMS = ("workerSubType", "jobType")

# Below this, the employer clearly isn't tagging its internships. Blue Origin's
# workerSubType facet reports 1 "Intern (Fixed Term)" while text search finds
# 17 real internships -- the rest are filed as "Regular". Trusting that facet
# would silently delete 16 jobs. RTX, by contrast, tags 49 properly.
