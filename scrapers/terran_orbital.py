...
COMPANY_NAME = "Terran Orbital"
BOARD_TOKEN = "terranorbitalcorporation"
...
def get_locations(job):
    """
    Greenhouse puts the headline location in location.name; a posting attached
    to several sites also carries an offices array. Read both so a job listed
    under a foreign headline but open at a US office is still caught.
    """
    parts = []
