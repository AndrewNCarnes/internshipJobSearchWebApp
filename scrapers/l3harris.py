...
SEARCH_URL = f"{BASE}/en/search-jobs?k=intern"
MAX_PAGES = 25    # ~19 cards per page; a fuse, not the normal exit
PAGE_DELAY = 1.5

# careers.l3harris.com renders results server-side -- a network probe found no
# jobs API, only 19 [data-job-id] cards in the HTML. So this reads the DOM and
# walks the ?p=N pages until a page repeats or comes back empty.
