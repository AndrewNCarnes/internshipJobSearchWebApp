...
def get_locations(job):
    ...
    attached to several sites also carries an offices array. Rocket Lab spans
    Long Beach, Albuquerque, Wallops and Auckland/Mahia, so a job listed under
    a New Zealand headline may still have a US office attached -- and vice
    versa. Collect every location string and let the filter judge them all.
    """
    parts = []
