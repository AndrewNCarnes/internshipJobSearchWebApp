...
API_BASE = "https://ottoaerospaceinc.wd108.myworkdayjobs.com/wday/cxs/ottoaerospaceinc/Otto_External_Careers"
API_URL = f"{API_BASE}/jobs"
BASE_JOB_URL = "https://ottoaerospaceinc.wd108.myworkdayjobs.com/en-US/Otto_External_Careers"

# Workday/Cloudflare returns 403 without Origin and Referer.
HEADERS = {
    "Accept": "application/json",
    "Content-Type": "application/json",
    "Origin": "https://ottoaerospaceinc.wd108.myworkdayjobs.com",
    "Referer": BASE_JOB_URL,
}

INTERN_FACET_PARAMS = ("workerSubType", "jobType")

# Otto left Greenhouse: boards-api returns 404 for every token and
# job-boards.greenhouse.io/ottoaviation now 500s. They moved to Workday
# (tenant ottoaerospaceinc, wd108), embedded as an iframe on
# ottoaerospace.com/careers/open-positions-2/.
#
# Below this threshold the employer isn't tagging internships and the facet
# can't be trusted. Otto is a ~11-person-hiring startup, so expect a tiny or
# absent facet and a text-search fallback -- which is correct, not a failure.
MIN_FACET_TRUST = 5
